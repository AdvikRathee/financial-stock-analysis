...
ToolPurposePython (Pandas, NumPy)Data cleaning, EDA, feature engineeringMatplotlib & SeabornCharts, distributions, visualizationsyfinanceLive stock data via Yahoo Finance APISQLData querying and aggregationPower BIInteractive dashboard
...
CompanyTotal ReturnAvg VolatilityBest DayWorst Day🏆 AMZN440.9%28.9%+14.13%-11.00%📈 MSFT225.3%22.6%+10.45%-11.40%📊 GOOGL168.5%22.0%+16.26%-5.41%🍎 AAPL135.1%23.2%+8.20%-7.99%
...
📸 Dashboard Preview
<img width="1374" height="794" alt="image" src="https://github.com/user-attachments/assets/2ed183e9-d865-4804-be13-44c4d6cf21cf" />
...
SQL:
sql-- Run stock_analysis.sql in any MySQL / SQL Server environment
